...
def plot_temperature(data_path):
    ...
    dates = dates.apply(lambda x: ''.join([month_translation.get(part, part) for part in x.split()]))
...
if __name__ == "__main__":
    input_file_path = r'e:\weather assignment\天气.csv'
    output_file_path = r'e:\weather assignment\天气_最高最低气温_新增列.csv'
